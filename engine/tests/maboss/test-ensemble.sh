...
$LAUNCHER $MABOSS --ensemble --save-individual -c ensemble/ensemble.cfg -o tmp/res ensemble/invasion/Invasion_0.bnet ensemble/invasion/Invasion_200.bnet ensemble/invasion/Invasion_400.bnet ensemble/invasion/Invasion_600.bnet ensemble/invasion/Invasion_800.bnet  ensemble/invasion/Invasion_1000.bnet
...
${PYTHON:-python} compare_fixpoints.py ensemble/refer/res_fp.csv tmp/res_fp.csv
check_file "fixpoints"

${PYTHON:-python} compare_fixpoints.py ensemble/refer/res_model_0_fp.csv tmp/res_model_0_fp.csv
check_file "fixpoints_model_0"
${PYTHON:-python} compare_fixpoints.py ensemble/refer/res_model_1_fp.csv tmp/res_model_1_fp.csv
check_file "fixpoints_model_1"
${PYTHON:-python} compare_fixpoints.py ensemble/refer/res_model_2_fp.csv tmp/res_model_2_fp.csv
check_file "fixpoints_model_2"
${PYTHON:-python} compare_fixpoints.py ensemble/refer/res_model_3_fp.csv tmp/res_model_3_fp.csv
check_file "fixpoints_model_3"
${PYTHON:-python} compare_fixpoints.py ensemble/refer/res_model_4_fp.csv tmp/res_model_4_fp.csv
check_file "fixpoints_model_4"
${PYTHON:-python} compare_fixpoints.py ensemble/refer/res_model_5_fp.csv tmp/res_model_5_fp.csv
